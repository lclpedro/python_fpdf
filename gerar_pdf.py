...
@app.route('/api/lei1358', methods=['GET'])
def gerar_lei1368():
	class PDF(FPDF):
		def header(self):
			self.set_font('Arial','', 8)
	...
	pdf.add_page('L')
	pdf.set_font('Arial','B',10)
	pdf.multi_cell(270,5,'4. MONITORAMENTO GERAL DO BENEFÍCIO DA LEI 1.358/00 E LEI 2.445/11 (PROCESSOS APROVADOS)',align='J')
	pdf.set_font('Arial','',8)
	pdf.cell(135,5,'PROCESSOS',1,0,'C')
	pdf.cell(135,5,'EMPRESAS',1,1,'C')
	pdf.cell(17,5,'Nº',1,0,'C')
	pdf.cell(20,5,'Ano',1,0,'C')
	pdf.cell(27,5,'Data Início',1,0,'C')
	pdf.cell(37,5,'Espécie',1,0,'C')
	pdf.cell(34,5,'Status',1,0,'C')
	pdf.cell(135,5,'Razão Social',1,1,'C')
	pdf.cell(17,5,'',1,0,'C')
	pdf.cell(20,5,'',1,0,'C')
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(37,5,'',1,0,'C')
	pdf.cell(34,5,'',1,0,'C')
	pdf.cell(135,5,'',1,1,'C')
	pdf.set_auto_page_break(auto=True)
	pdf.add_page('L')
	pdf.cell(67.5,5,'REGISTROS',1,0,'C')
	pdf.cell(67.5,5,'RESOLUÇÕES',1,0,'C')
	pdf.cell(67.5,5,'DIÁRIO OFICIAL',1,0,'C')
	pdf.cell(67.5,5,'TERMOS DE ACORDO',1,1,'C')
	pdf.cell(33.75,5,'CNPJ',1,0,'C')
	pdf.cell(33.75,5,'Insc. Estadual',1,0,'C')
	pdf.cell(12.5,5,'Nº',1,0,'C')
	pdf.cell(22.5,5,'Data',1,0,'C')
	pdf.cell(32.5,5,'Espécie',1,0,'C')
	pdf.cell(33.75,5,'Nº',1,0,'C')
	pdf.cell(33.75,5,'Data',1,0,'C')
	pdf.cell(10.875,5,'Nº',1,0,'C')
	pdf.cell(19.875,5,'Assinat.',1,0,'C')
	pdf.cell(19.875,5,'Duração',1,0,'C')
	pdf.cell(16.875,5,'Término',1,1,'C')
	pdf.cell(33.75,5,'',1,0,'C')
	pdf.cell(33.75,5,'',1,0,'C')
	pdf.cell(12.5,5,'',1,0,'C')
	pdf.cell(22.5,5,'',1,0,'C')
	pdf.cell(32.5,5,'',1,0,'C')
	pdf.cell(33.75,5,'',1,0,'C')
	pdf.cell(33.75,5,'',1,0,'C')
	pdf.cell(10.875,5,'',1,0,'C')
	pdf.cell(19.875,5,'',1,0,'C')
	pdf.cell(19.875,5,'',1,0,'C')
	pdf.cell(16.875,5,'',1,1,'C')
	pdf.set_auto_page_break(auto=True)
	pdf.add_page('L')
	pdf.cell(135,5,'FINANCIAMENTOS',1,0,'C')
	pdf.cell(135,5,'TAXA ADM. DO FDS ',1,1,'C')
	pdf.multi_cell(10.285714,10,'Nível',1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+10.285714,y-10)
	pdf.multi_cell(19.285714,5,'Val. Finan. Ativo Fixo',1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+29.571428,y-10)
	pdf.multi_cell(22.285714,5,'V. Financ. At. Fixo (Total)',1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+51.857142,y-10)
	pdf.multi_cell(19.285714,10,'Val. Utilizado',1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+71.142856,y-10)
	pdf.multi_cell(22.285714,5,'V. Utilizado \n(Total)',1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+93.42857,y-10)
	pdf.multi_cell(19.285714,10 ,'Val. Saldo',1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+112.714284,y-10)
	pdf.multi_cell(22.285714,5,'V. Saldo \n(Total)',1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+134.999998,y-10)
	pdf.multi_cell(22.5,10,'Val. Taxa Adm.', 1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+157.499998,y-10)
	pdf.multi_cell(22.5,10,'Qtd. de Parcs.', 1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+179.999998,y-10)
	pdf.multi_cell(22.5,10,'Val. Parcs.', 1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+202.499998,y-10)
	pdf.multi_cell(22.5,10,'Parcs. Pagas*', 1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+224.999998,y-10)
	pdf.multi_cell(22.5,10,'Parcs. Rest.', 1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.set_xy(x+247.499998,y-10)
	pdf.multi_cell(22.5,5,'Status da Cobrança', 1,1,'C')
	pdf.cell(10.285714,5,'',1,0,'C')
	pdf.cell(19.285714,5,'',1,0,'C')
	pdf.cell(22.285714,5,'',1,0,'C')
	pdf.cell(19.285714,5,'',1,0,'C')
	pdf.cell(22.285714,5,'',1,0,'C')
	pdf.cell(19.285714,5 ,'',1,0,'C')
	pdf.cell(22.285714,5,'',1,0,'C')
	...
	pdf.cell(22.5,5,'', 1,0,'C')
	pdf.cell(22.5,5,'', 1,0,'C')
	pdf.cell(22.5,5,'', 1,1,'C')
	pdf.set_auto_page_break(auto=True)
	pdf.add_page()
	pdf.cell(190,5,'RESUMO GERAL - LEI 1.358/00',1,1,'C')
	pdf.cell(190,5,'1- Quantidade de Empresas Com:',1,1,'L')
	pdf.cell(95,5,'* Benefícios Aprovados',1,0,'L')
	pdf.cell(95,5,' - ',1,1,'C')
	pdf.cell(95,5,'* Benefícios Revogados',1,0,'L')
	pdf.cell(95,5,' - ',1,1,'C')
	pdf.cell(190,5,'2- Valor Total do Financiamentos Concedidos:',1,1,'L')
	pdf.cell(95,5,'* 1ºS Financiamentos (+)',1,0,'L')
	pdf.cell(95,5,' R$',1,1,'C')
	pdf.cell(95,5,'* Reavaliações (+)',1,0,'L')
	pdf.cell(95,5,' R$ ',1,1,'C')
	pdf.cell(95,5,'Total Geral (R$)',1,0,'C')
	pdf.cell(95,5,' R$ ',1,1,'C')
	pdf.cell(190,5,'2.1- Valor Total dos Créditos Utilizados:',1,1,'L')
	pdf.cell(95,5,'* 1ºS Financiamentos (-)',1,0,'L')
	pdf.cell(95,5,' R$',1,1,'C')
	pdf.cell(95,5,'* Reavaliações (-)',1,0,'L')
	pdf.cell(95,5,' R$ ',1,1,'C')
	pdf.cell(95,5,'Total Geral (R$)',1,0,'C')
	pdf.cell(95,5,' R$ ',1,1,'C')
	pdf.cell(190,5,'2.2- Valor Total dos Créditos Restantes (Saldos):',1,1,'L')
	pdf.cell(95,5,'* 1ºS Financiamentos (=)',1,0,'L')
	pdf.cell(95,5,' R$',1,1,'C')
	pdf.cell(95,5,'* Reavaliações (=)',1,0,'L')
	pdf.cell(95,5,' R$ ',1,1,'C')
	pdf.cell(95,5,'Total Geral (R$)',1,0,'C')
	pdf.cell(95,5,' R$ ',1,1,'C')
	pdf.cell(190,5,'2.4- Valor Total dos Financiamentos Revogados:',1,1,'L')
	pdf.cell(95,5,'* Revogados (-)',1,0,'L')
	pdf.cell(95,5,' R$',1,1,'C')
	pdf.cell(95,5,'Total Geral (R$)',1,0,'C')
	pdf.cell(95,5,' R$ ',1,1,'C')
	pdf.cell(190,5,'RESUMO GERAL - LEI 2.445/11',1,1,'C')
	pdf.cell(190,5,'1- Quantidade de Empresas com: ',1,1,'L')
	pdf.cell(95,5,'* Benefícios Aprovados',1,0,'L')
	pdf.cell(95,5,'-',1,1,'C')
	pdf.cell(190,5,'2- Valor Total de Financiamentos Reg. Especial Concedidos: ',1,1,'L')
	pdf.cell(95,5,'* 1ºS Financiamentos (+)',1,0,'L')
	pdf.cell(95,5,'-',1,1,'C')
	pdf.cell(95,5,'Total Geral (R$)',1,0,'C')
	pdf.cell(95,5,' R$ ',1,1,'C')
...
def gerar_resultados():
	...
	pdf.add_page('L')
	pdf.set_font('Arial','B',10)
	pdf.multi_cell(270,5,'6.7- RESULTADO DOS I14',align='J')
	pdf.set_font('Arial','',8)
	pdf.cell(25,5,'Processos',1,0,'C')
	pdf.cell(65,5,'Empresas',1,0,'C')
	pdf.cell(45,5,'Atividade Econômica Principal',1,0,'C')
	pdf.cell(25,5,'Benefícios',1,0,'C')
	pdf.cell(35,5,'Localização',1,0,'C')
	pdf.cell(75,5,'Dados Gerais - 2014',1,1,'C')
	pdf.cell(12.5,5,'Nº',1,0,'C')
	pdf.cell(12.5,5,'Ano',1,0,'C')
	pdf.cell(32.5,5,'Razão Social',1,0,'C')
	pdf.cell(32.5,5,'Nome Fantasia',1,0,'C')
	pdf.cell(12.5,5,'Cód',1,0,'C')
	pdf.cell(32.5,5,'Descrição',1,0,'C')
	pdf.cell(25,5,'Leis Nº:',1,0,'C')
	pdf.cell(35,5,'Áreas:',1,0,'C')
	pdf.cell(18.75,5,'Empregos:',1,0,'C')
	pdf.cell(18.75,5,'Porte',1,0,'C')
	pdf.cell(18.75,5,'Investimentos',1,0,'C')
	pdf.cell(18.75,5,'Faturamento',1,1,'C')
	pdf.cell(12.5,5,'',1,0,'C')
	pdf.cell(12.5,5,'',1,0,'C')
	pdf.cell(32.5,5,'',1,0,'C')
	pdf.cell(32.5,5,'',1,0,'C')
	...
	pdf.cell(25,5,'',1,0,'C')
	pdf.cell(35,5,'',1,0,'C')
	pdf.cell(18.75,5,'',1,0,'C')
	pdf.cell(18.75,5,'',1,0,'C')
	pdf.cell(18.75,5,'',1,0,'C')
	pdf.cell(18.75,5,'',1,1,'C')
	fn = 'download.pdf'
	pdfgerado = make_response(u''.join(pdf.output(fn,dest='S')).encode('latin-1'))
	pdfgerado.headers.set('Content-Disposition', 'attachment', filename=fn)
	pdfgerado.headers.set('Content-Type', 'application/pdf')
...
@app.route('/api/taxa_fds', methods=['GET'])
def gerar_taxas():
	class PDF(FPDF):
		def header(self):
			self.set_font('Arial','', 8)
	...
	pdf.add_page('L')
	pdf.set_font('Arial','B',10)
	pdf.multi_cell(270,5,'4.1 - MONITORAMENTO DA RECEITA GERAL DO FUNDO E DESENVOLVIMENTO SUSTENTÁVEL - FDS',align='J')
	pdf.set_font('Arial','',8)
	pdf.cell(14,15,'Nº Parcela',1,0,'C')
	x=pdf.get_x()
	y=pdf.get_y()
	pdf.cell(54,5,'Dados da Emissão',1,0,'C')
	pdf.cell(54,5,'Dados da Entrega',1,0,'C')
	pdf.cell(54,5,'(*) Dados de Pagamento',1,0,'C')
	pdf.cell(104,15,'Status da Cobrança',1,1,'C')
	pdf.set_xy(x,y+5)
	pdf.multi_cell(18,5,'Data de Emissão',1,0,'C')
	pdf.set_xy(x+18,y+5)
	pdf.multi_cell(18,5,'Vencimento/ Referência',1,0,'C')
	pdf.set_xy(x+36,y+5)
	pdf.multi_cell(18,5,'Valor da Parcela (R$)',1,0,'C')
	pdf.set_xy(x+54,y+5)
	pdf.multi_cell(27,5,'Forma / Instrumento',1,0,'C')
	pdf.set_xy(x+81,y+5)
	pdf.multi_cell(27,5,'Entrega / Recebimento',1,0,'C')
	pdf.set_xy(x+108,y+5)
	pdf.multi_cell(27,5,'Data de Pagamento',1,0,'C')
	pdf.set_xy(x+135,y+5)
	pdf.multi_cell(27,10,'Valor Pago (R$)',1,1,'C')
	pdf.cell(14,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	...
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(104,5,'',1,1,'C')
	pdf.cell(122,5,'Quantidade de Parcelas e Total de Valores Pagos (R$)',1,0,'C')
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(104,5,'',1,1,'C')
	pdf.cell(176,10,'RAZÃO SOCIAL - 1ª REAVALIAÇÃO CNPJ:     INSC.ESTADUAL:',1,0,'C')
	pdf.cell(104,10,'ENCERRADO COM PENDÊNCIA',1,1,'C')
	pdf.cell(14,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	...
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(104,5,'',1,1,'C')
	pdf.cell(149,5,'Total Geral do Parcelamento Pago (R$)',1,0,'C')
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(104,5,'',1,1,'C')
	pdf.cell(280,5,'RECOLHIMENTO DE EMPRESAS DIVERSAS IDENTIFICADAS:',1,1,'C')
	pdf.cell(280,5,'RAZÃO SOCIAL - 1ª REAVALIAÇÃO CNPJ:     INSC.ESTADUAL:',1,1,'C')
	pdf.cell(14,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	...
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(104,5,'',1,1,'C')
	pdf.cell(149,5,'Total de Recolhimentos de Empresas Diversas - Identificadas (R$) ',1,0,'C')
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(104,5,'',1,1,'C')
	pdf.cell(280,5,'RECOLHIMENTOS DE EMPRESAS DIVERSAS - NÃO IDENTIFICADAS:',1,1,'C')
	pdf.cell(14,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	pdf.cell(18,5,'',1,0,'C')
	...
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(104,5,'',1,1,'C')
	pdf.cell(149,5,'Total de Recolhimentos de Empresas Diversas - Não Identificadas (R$) ',1,0,'C')
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(104,5,'',1,1,'C')
	pdf.cell(149,5,'Total Geral (R$) ',1,0,'C')
	pdf.cell(27,5,'',1,0,'C')
	pdf.cell(104,5,'',1,1,'C')
	pdf.set_auto_page_break(auto=True)
	pdf.add_page()
	pdf.cell(190,5,'FDS - RESUMO DA RECEITA (CÓD. 69)',1,1,'C')
	pdf.cell(190,5,'1 - VALORES RECOLHIDOS',1,1,'C')
	pdf.cell(95,5,'1.1 Origem',1,0,'L')
	pdf.cell(95,5,'Valor (R$)',1,1,'L')
	pdf.cell(95,5,'',1,0,'C')
	pdf.cell(95,5,'',1,1,'C')
	pdf.cell(95,5,'TOTAL (R$)',1,0,'C')
	pdf.cell(95,5,'',1,1,'C')
	pdf.cell(95,5,'1.2 Período:',1,0,'L')
	pdf.cell(95,5,'Valor (R$)',1,1,'C')
	pdf.cell(47.5,5,'',1,0,'C')
	pdf.cell(47.5,5,'',1,0,'C')
	pdf.cell(95,5,'',1,1,'C')
	pdf.cell(95,5,'TOTAL (R$)',1,0,'C')
	pdf.cell(95,5,'',1,1,'C')
	pdf.cell(190,5,'2 - VALORES A RECOLHER',1,1,'C')
	pdf.cell(95,5,'2.1 - Origem',1,0,'L')
	pdf.cell(95,5,'Valor (R$)',1,1,'L')
	pdf.cell(95,5,' ',1,0,'C')
	pdf.cell(95,5,' ',1,1,'C')
	pdf.cell(95,5,'TOTAL (R$)',1,0,'C')
	pdf.cell(95,5,' ',1,1,'C')
	pdf.cell(190,5,'3 - VALORES PERDIDOS:',1,1,'C')
	pdf.cell(95,5,'3.1 - Origem:',1,0,'L')
	pdf.cell(95,5,'Valor (R$)',1,1,'L')
	pdf.cell(95,5,' ',1,0,'C')
	pdf.cell(95,5,' ',1,1,'C')
	pdf.cell(95,5,'TOTAL (R$)',1,0,'C')
	...
	pdf.set_auto_page_break(auto=True)
	pdf.add_page()
	pdf.cell(190,5,'FDS - PREVISÃO DE RECOLHIMENTO¹²',1,1,'C')
	pdf.cell(95,5,'Período',1,0,'C')
	y=pdf.get_y()
	pdf.cell(95,10,'Valores',1,1,'C')
	pdf.set_y(y+5)
	pdf.cell(47.5,5,'De:',1,0,'C')
	pdf.cell(47.5,5,'à:',1,1,'C')
	pdf.cell(47.5,5,'',1,0,'C')
	pdf.cell(47.5,5,'',1,0,'C')
	pdf.cell(95,5,'',1,1,'C')
	pdf.cell(95,5,'TOTAL (R$)',1,0,'C')
...
@app.route('/api/lei1359', methods=['GET'])
def gerar_lei1359():
	class PDF(FPDF):
		def header(self):
			self.set_font('Arial','', 8)
	...
	pdf.add_page('L')
	pdf.set_font('Arial','B',10)
	pdf.multi_cell(270,5,'5. MONITORAMENTO GERAL DO BENEFÍCIO DA LEI 1.359/00 E \
		LEI 1.684/05 (PROCESSOS APROVADOS)',align='J')
	pdf.set_font('Arial','',8)
	pdf.cell(77.5,5,'PROCESSOS',1,0,'C')
	pdf.cell(47.5,5,'EMPRESAS',1,0,'C')
	pdf.cell(67.5,5,'REGISTROS',1,0,'C')
	pdf.cell(77.5,5,'RESOLUÇÕES',1,1,'C')
	pdf.cell(10.5,5,'Nº',1,0,'C')
	pdf.cell(10.5,5,'Ano',1,0,'C')
	pdf.cell(15.5,5,'Data Início',1,0,'C')
	pdf.cell(15.5,5,'Espécie',1,0,'C')
	pdf.cell(25.5,5,'Status',1,0,'C')
	pdf.cell(47.5,5,'Razão Social',1,0,'C')
	pdf.cell(33.75,5,'CNPJ',1,0,'C')
	pdf.cell(33.75,5,'Insc. Estadual',1,0,'C')
	pdf.cell(15.833,5,'Nº',1,0,'C')
	pdf.cell(25.833,5,'Data',1,0,'C')
	pdf.cell(35.833,5,'Espécie',1,1,'C')
	...
	pdf.cell(33.75,5,'',1,0,'C')
	pdf.cell(33.75,5,'',1,0,'C')
	pdf.cell(15.833,5,'',1,0,'C')
	pdf.cell(25.833,5,'',1,0,'C')
	pdf.cell(35.833,5,'',1,1,'C')
	pdf.set_auto_page_break(auto=True)
	pdf.add_page('L')
	pdf.cell(90,5,'DIÁRIO OFICIAL',1,0,'C')
	pdf.cell(90,5,'CONCESSÃO',1,0,'C')
	pdf.cell(90,5,'DOAÇÃO',1,1,'C')
	pdf.cell(45,5,'Nº',1,0,'C')
	pdf.cell(45,5,'Data',1,0,'C')
	pdf.cell(22.5,5,'Doc.',1,0,'C')
	pdf.cell(22.5,5,'Data',1,0,'C')
	pdf.cell(22.5,5,'Duração',1,0,'C')
	pdf.cell(22.5,5,'Término',1,0,'C')
	pdf.cell(45,5,'Nº',1,0,'C')
	pdf.cell(45,5,'Data',1,1,'C')
	pdf.cell(45,5,'',1,0,'C')
	pdf.cell(45,5,'',1,0,'C')
	pdf.cell(22.5,5,'',1,0,'C')
	pdf.cell(22.5,5,'',1,0,'C')
	...
	pdf.set_auto_page_break(auto=True)
	pdf.add_page('L')
	pdf.cell(90,5,'DADOS DA ÁREA CONCEDIDA/DOADA',1,0,'C')
	pdf.cell(130,5,'FISC. DOS PRAZOS CONCEDIDOS P/ OBRA',1,0,'C')
	pdf.cell(50,5,'FISC. DO USO DO IMÓVEL',1,1,'C')
	pdf.cell(22.5,5,'Loteamento',1,0,'C')
	pdf.cell(22.5,5,'Local',1,0,'C')
	pdf.cell(22.5,5,'Area (m²)',1,0,'C')
	pdf.cell(22.5,5,'Matríc.',1,0,'C')
	pdf.cell(32.5,5,'Ref. ao Início',1,0,'C')
	pdf.cell(32.5,5,'Dias Decorridos',1,0,'C')
	pdf.cell(32.5,5,'Ref. à Conclus.',1,0,'C')
	pdf.cell(32.5,5,'Meses Decorridos',1,0,'C')
	pdf.cell(25,5,'Status',1,0,'C')
	pdf.cell(25,5,'Efetiva Produção',1,1,'C')
	pdf.cell(22.5,5,'',1,0,'C')
	pdf.cell(22.5,5,'',1,0,'C')
	pdf.cell(22.5,5,'',1,0,'C')
	pdf.cell(22.5,5,'',1,0,'C')
	...
	pdf.set_auto_page_break(auto=True)
	pdf.add_page()
	pdf.cell(190,5,'RESUMO GERAL - LEI 1.359/00,',1,1,'C')
	pdf.cell(190,5,'1- Quantidade de Empresas com:',1,1,'L')
	pdf.cell(95,5,'* Benefícios Aprovados',1,0,'L')	
	pdf.cell(95,5,'',1,1,'C')	
	pdf.cell(95,5,'* Benefícios Revogados',1,0,'L')
	pdf.cell(95,5,'',1,1,'C')	
	pdf.cell(190,5,'2- Metragem Total das Áreas Concedidas/Doadas:',1,1,'L')
	pdf.cell(95,5,'* Metragem Total das Áreas Concedidas',1,0,'L')	
	pdf.cell(95,5,'',1,1,'C')	
	pdf.cell(95,5,'* Metragem Total das Áreas Doadas',1,0,'L')	
	pdf.cell(95,5,'',1,1,'C')
	pdf.cell(95,5,'TOTAL GERAL (m²)',1,0,'C')	
	pdf.cell(95,5,'',1,1,'C')
	pdf.cell(190,5,'3- Metragem Total das Áreas Revogadas:',1,1,'L')
	pdf.cell(95,5,'* Metragem Total das Áreas Revogadas',1,0,'L')	
	pdf.cell(95,5,'',1,1,'C')	
	pdf.cell(95,5,'TOTAL GERAL (m²)',1,0,'C')	
	pdf.cell(95,5,'',1,1,'C')
	pdf.cell(190,5,'RESUMO GERAL - LEI 1.684/05',1,1,'C')
	pdf.cell(190,5,'1- Quantidade de Empresas com:',1,1,'L')
	pdf.cell(95,5,'* Benefícios Aprovados',1,0,'L')	
	pdf.cell(95,5,'',1,1,'C')
	pdf.cell(190,5,'2- Metragem Total de Áreas Concedidas:',1,1,'L')
	pdf.cell(95,5,'* Metragem Total de Áreas Concedidas',1,0,'L')	
	pdf.cell(95,5,'',1,1,'C')
	pdf.cell(95,5,'TOTAL GERAL (m²)',1,0,'C')	
	pdf.cell(95,5,'',1,1,'C')
	fn = 'download.pdf'
